		...
		public struct Enumerator : IEnumerator<T>, IEnumerator
		{
			...
			object IEnumerator.Current
			{
				get
				{
					...
					if (this._index == 0 || this._index == (this._gapBuffer.Count + 1))
						throw new InvalidOperationException(Resource.InvalidOperation_EnumOpCantHappen);
			...
			public bool MoveNext()
			{
				...
				if (this._version != this._gapBuffer._version)
					throw new InvalidOperationException(Resource.InvalidOperation_EnumFailedVersion);
