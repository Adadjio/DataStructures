	...
	public partial class GapBuffer<T> : IList<T>, IList
	{
		...
		public int Capacity
		{
			...
			set
			{
				...
				if (value < Count)
					throw new ArgumentOutOfRangeException("value", Resource.ArgumentOutOfRange_SmallCapacity);
		...
		public T this[int index]
		{
			get
			{
				if (index < 0 || index >= Count)
					throw new ArgumentOutOfRangeException("index", Resource.ArgumentOutOfRange_Index);
		...
		public void CopyTo(T[] array, int arrayIndex)
		{
			...
			if (arrayIndex < 0)
				throw new ArgumentOutOfRangeException("arrayIndex", Resource.Argument_InvalidOffLen);
			
			if (array.Rank != 1)
				throw new ArgumentException(Resource.Argument_RankMultiDimNotSupported, "array");

			if (arrayIndex >= array.Length || arrayIndex + Count > array.Length)
				throw new ArgumentException(Resource.Argument_InvalidOffLen, "arrayIndex");
		...
		void ICollection.CopyTo(Array array, int arrayIndex)
		{
			...
			{
				throw new ArgumentException(Resource.Argument_InvalidArrayType, "array");
			}
			catch
			{
				throw;
		...
		public void RemoveRange(int index, int count)
		{
			...
			if (count < 0 || size - index < count)
				throw new ArgumentOutOfRangeException("count", Resource.ArgumentOutOfRange_Count);
		...
		private static void VerifyValueType(object value)
		{
			...
			if (!IsCompatibleObject(value))
			{
				string message = String.Format(CultureInfo.CurrentCulture, Resource.Argument_WrongType, value, typeof(T));
